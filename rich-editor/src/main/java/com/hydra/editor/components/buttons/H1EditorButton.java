 ...
 */
public class H1EditorButton extends EditorButton {
    ...
    public int getDefaultDrawable() {
        return R.mipmap.icon_editor_h1;
    }
    ...
    public int getActiveDrawable() {
        return R.mipmap.icon_editor_h1_;
    }
