 ...
 */
public class UnderlineEditorButton extends EditorButton {
    ...
    public int getDefaultDrawable() {
        return R.mipmap.icon_editor_underline;
    }
    ...
    public int getActiveDrawable() {
        return R.mipmap.icon_editor_underline_;
    }
    ...
    public EditorInputType getEditorInputType() {
        return EditorInputType.UNDERLINE;
    }
}
