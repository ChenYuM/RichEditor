 ...
 */
public class H3EditorButton extends EditorButton {
    ...
    public int getDefaultDrawable() {
        return R.mipmap.icon_editor_h3;
    }
    ...
    public int getActiveDrawable() {
        return R.mipmap.icon_editor_h3_;
    }
