 ...
 */
public class H6EditorButton extends EditorButton {
    ...
    public int getDefaultDrawable() {
        return R.mipmap.icon_editor_h6;
    }
    ...
    public int getActiveDrawable() {
        return R.mipmap.icon_editor_h6_;
    }
